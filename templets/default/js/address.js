...
/**
 * 初始省
 * @param {Object} objp	省份对应的select对象
 * @param {Object} objc	城市对应的select对象
 * @param {Object} pvalue	省份默认值
 * @param {Object} cvalue	城市默认值
 * 示例:InitPrviCitySelect(objp, objc, '110000', '110101');
 * 示例:InitPrviCitySelect(objp, objc, 0, 0);不选择值
 */ 
//InitPrviCitySelect($("#province"), $("#city"), 440000, cvalue);